...
var selfcrdsResource = schema.GroupVersionResource{Group: "clustar.ai", Version: "v1", Resource: "selfcrds"}

var selfcrdsKind = schema.GroupVersionKind{Group: "clustar.ai", Version: "v1", Kind: "SelfCRD"}
...
func (c *FakeSelfCRDs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *selfcrdv1.SelfCRD, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(selfcrdsResource, c.ns, name, data, subresources...), &selfcrdv1.SelfCRD{})
